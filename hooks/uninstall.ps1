# shell — uninstaller for the SessionStart + UserPromptSubmit hooks (Windows PowerShell)
...
#   or:  irm https://raw.githubusercontent.com/DyxBenjamin/shelldon/main/hooks/uninstall.ps1 | iex
param()
...
Write-Host "Uninstalling shell hooks..."
...
if (Test-Path $Settings) {
    if (-not (Get-Command node -ErrorAction SilentlyContinue)) {
        ...
        Write-Host "         Remove the shell SessionStart and UserPromptSubmit"
...
Write-Host "  npx skills remove shell      # Cursor, Windsurf, Cline, Copilot, etc."
Write-Host "  claude plugin disable shell   # Claude Code plugin"
Write-Host "  gemini extensions uninstall shell  # Gemini CLI"
